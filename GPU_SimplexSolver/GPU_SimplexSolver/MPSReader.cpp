...
void MPSReader::readFObjetivo(FObjetivo *func, std::string MPSLocation){
	//TODO: funcoes que irao ler o arquivo MPS e adicionar as informacoes na funcao
	funcao = func; //O ponteiro local recebe o conteudo apontado pelo param.
	fileReader = new FileReader(MPSLocation);

	readMPSProblem();
}

void MPSReader::readMPSProblem(){
